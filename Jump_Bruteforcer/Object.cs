...
namespace Jump_Bruteforcer
{
    ...
    public class Object
    {
        ...
        private static readonly Dictionary<ObjectType, CollisionType> toCollisionType = new()
        {
            ...
            {ObjectType.LineSpikeUp, CollisionType.Killer },
            {ObjectType.LineSpikeRight,CollisionType.Killer },
            {ObjectType.LineSpikeLeft,CollisionType.Killer },
            {ObjectType.LineSpikeDown,CollisionType.Killer },
            {ObjectType.LineMiniSpikeUp,CollisionType.Killer },
            {ObjectType.LineMiniSpikeRight,CollisionType.Killer },
            {ObjectType.LineMiniSpikeLeft,CollisionType.Killer },
            {ObjectType.LineMiniSpikeDown,CollisionType.Killer },
